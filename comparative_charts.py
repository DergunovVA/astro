...
def calculate_chart(date_str: str, time_str: str, place_str: str, 
                   chart_type: str = "natal", 
                   tz_override: Optional[str] = None,
                   lat_override: Optional[float] = None,
                   lon_override: Optional[float] = None) -> dict:
    """
...
def comparative_charts(date_str: str, time_str: str, 
                      cities: List[str],
                      chart_type: str = "natal",
                      tz_override: Optional[str] = None) -> dict:
    """
